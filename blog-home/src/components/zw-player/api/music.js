...
export const getDefaultMusic = () => {
  return [
    {
      id: 1,
      musicCover: "https://iksling.com/static/mp3/rxts/rxts.jpg",
...
export const getCollectionMusic = () => {
  return axios.get("/api/musics/collection", {
    params: {
      size: 200,
      current: 1
    }
...
export const collectMusic = id => {
  return axios.post("/api/music/collect/" + id);
};
