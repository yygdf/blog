<template>
  <el-card class="main-card">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="200">
        <template slot-scope="scope">
          ...
          >
            <el-button size="mini" class="smallerBtn" type="danger" slot="reference">
    ...
    <!-- 新增模态框 -->
    <el-dialog :visible.sync="addResource" width="30%" @close="closeDialog">
      ...
      <el-form label-width="80px" size="medium" :model="resourceForm">
        ...
        <el-form-item label="模块名" v-if="isEdit">
          <el-select
        ...
        <el-form-item label="禁用">
          <el-switch
            v-model="resourceForm.isDisable"
            active-color="#13ce66"
            inactive-color="#F4F4F5"
            :active-value="1"
            :inactive-value="0"
...
export default {
  ...
  methods: {
    ...
    openAddResourceModel(resource) {
      this.resourceForm = {};
      var obj = { requestMethod: "GET", parentId: resource.id };
