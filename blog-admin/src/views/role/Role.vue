    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="openMenuModel(scope.row)">
...
export default {
  ...
  methods: {
    ...
    changeDisable(role) {
      ...
      param.append("isDisable", role.isDisable);
      this.axios.put("/api/admin/role/disable/" + role.id, param);
    },
